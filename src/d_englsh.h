...
// Obituary Strings
// Always follow the format of source THEN target in naming
#define OBT_FIST "%s PUNCHES UP %s"
#define OBT_PISTOL "%s FIRES ONE IN %s"
#define OBT_SHOTGUN "%s LEAVES %s IN SHELLSHOCK"
#define OBT_CHAINGUN "%s IS GUNNED DOWN BY %s"
#define OBT_RL "%s BLASTS %s AWAY"
#define OBT_PLASMA "%s ELECTRIFIES %s"
#define OBT_BFG "%s LEAVES %s IN LITTLE PIECES"
#define OBT_CHAINSAW "%s CUTS UP %s"
#define OBT_SUPERSHOTGUN "%s DOUBLE BARRELS %s"
#define OBT_BETAPLASMA1 "%s FRIES %s"
#define OBT_BETAPLASMA2 "%s BURNS %s AWAY"

#define SELF_OBT_FIST "%s IS MASACHISTIC"
#define SELF_OBT_PISTOL "%s BITES THE BULLET"
#define SELF_OBT_SHOTGUN "%s IS A LITTLE SHELLSHOCKED"
#define SELF_OBT_CHAINGUN "%s LIES IN CHAINS"
#define SELF_OBT_RL "%s HAS TERRIBLE AIM"
#define SELF_OBT_PLASMA "%s LIT THE BLUE TOUCH PAPER"
#define SELF_OBT_BFG "%s STOOD TOO CLOSE"
#define SELF_OBT_CHAINSAW "%s IS MASACHISTIC"
#define SELF_OBT_SUPERSHOTGUN "%s LIKES THEIR DOUBLE BARRELS"
#define SELF_OBT_BETAPLASMA1 "%s LIT THE GREEN TOUCH PAPER"
#define SELF_OBT_BETAPLASMA2 "%s LIT THE GREEN TOUCH PAPER"
