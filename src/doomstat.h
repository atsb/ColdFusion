...
// Menu Variables
extern int menu_bg;        // Hakx 5/14/99 Draw the menu background or not
extern char* menu_bg_name; // The name of the flat for the background

// Console Variables
extern player_t* c_player;
extern char* c_input;

// Bug Fix/Optimisation Variables
extern int single_side_pass; // Hakx 5/17/99
extern int mbf_invis; // Hakx 5/22/99

// Cheat
extern int infinite_ammo; // Hakx 7/31/1999

// Player Vars
extern int obituaries;   // Hakx 8/9/1999 [Obit Code]
extern char* cl_name;    // Hakx 8/9/1999
extern int cl_palettefx; // Hakx 10/11/1999
extern int jumpheight;   // Hakx 10/19/1999
extern fixed_t sv_gravity;   // Hakx 10/19/1999
extern int cl_drawweapon; // Hakx 2/14/00

// Mlook Related
extern int     mlookon;
extern int     invertmouse;
extern fixed_t keylookspeed;
extern fixed_t mlookspeed;
