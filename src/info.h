...
// Fusion
  ...
  MT_DEAD_REVENANT, // Hakx 7/19/99
  MT_DEAD_SPECTRE,  // Added New Corpse Sprites.
  MT_DEAD_MANCUBUS, // They use the doomednums: 10101-10111
  MT_DEAD_ARCHVILE,
  MT_DEAD_ARACHNOTRON,
  MT_DEAD_HELLKNIGHT,
  MT_DEAD_COMMANDO,
...
typedef struct
{
    ...
    int flags2;       // Hakx 5/14/99 Flags 2, for greater options
